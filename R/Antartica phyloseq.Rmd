...
```{r, fig.height=8, fig.width=8}
  ...
  for (one_sample_type in sample_type_all) {
      ...
      bargraph_asv [[one_sample_type]] <- phyloseq_long_bargraph(long[[one_sample_type]], text_scaling = 0.5,use_asv = TRUE, 
                                                                title = one_sample_type)
      bargraph_species[[one_sample_type]] <- phyloseq_long_bargraph(long[[one_sample_type]], text_scaling = 0.5,use_asv = FALSE, 
                                                                title = one_sample_type)
